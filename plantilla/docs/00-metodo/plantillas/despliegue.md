...
> la máquina, 4-5 después. Vive en `docs/05-trabajo/NNN-slug/despliegue.md`; si no nace de una
> unidad (hotfix), se pega entera en la sección 6 · Cierre de `docs/bugs/NNN-slug.md`.
