...
> sesión nueva. El padre, en cualquier rol, JAMÁS escribe código. Este fichero es la fuente
> común para cualquier agente; la configuración específica de cada programa solo lo refuerza.
...
- **Qué hace:** recorre las fases con el usuario. Descompone el mapa, investiga (fase 3), planifica
  el ROADMAP (fase 4), especifica unidades (5), las despacha a subagentes constructores que
  las implementan (6), y ejecuta el ritual de cierre (7).
...
- **Nunca:** editar `main/` ni los worktrees; construir él mismo lo que puede despachar;
